      ...
      >
        ...
        <Toolbar>
          ...
          <div>
            ...
            <SnackbarMessage openSnackbar={openSnackbar} setOpenSnackbar={setOpenSnackbar} snackbarMessage={`${editUser?.first_name} ${editUser?.last_name} edited successfully`}></SnackbarMessage>
